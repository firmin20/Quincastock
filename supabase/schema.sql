...
-- Politiques RLS : PRO_CODES (Accès lecture restreint pour l'utilisateur authentifié)
create policy "Les utilisateurs authentifiés peuvent lire les codes pro" 
  on public.pro_codes for select 
  using (auth.role() = 'authenticated');

-- 7. FONCTION ATOMIQUE D'ACTIVATION DE CODE PRO
...
-- 8. TRIGGER DE CRÉATION AUTOMATIQUE DE PROFIL LORS DE L'INSCRIPTION
