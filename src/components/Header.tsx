        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-400 font-medium truncate max-w-[180px] sm:max-w-xs">
                {userProfile?.businessName ? (
                  <span className="text-gray-300 font-semibold">{userProfile.businessName}</span>
                ) : (
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            {!isPro && (
              <button
                ...
                onClick={onOpenPro}
                className="hidden md:inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold bg-orange-500 hover:bg-orange-600 text-white shadow transition-all cursor-pointer"
              >
            ...
            {/* Profile Button */}
            {onNavigateProfile && userProfile && (
              <button
                id="header-profile-btn"
                onClick={onNavigateProfile}
                className="inline-flex items-center px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-semibold bg-gray-800 hover:bg-gray-700 text-gray-200 border border-gray-700 transition-colors cursor-pointer"
                title="Mon compte"
              >
            ...
            <div className="relative">
              <button
                ...
                className="inline-flex items-center px-3 sm:px-3.5 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-bold bg-gray-800 hover:bg-gray-700 text-gray-100 border border-gray-700 hover:border-gray-600 transition-all cursor-pointer shadow-sm"
              >
                <Phone className="w-3.5 h-3.5 sm:mr-1.5 text-orange-500" />
            ...
            {onSignOut && (
              <button
                ...
                onClick={onSignOut}
                className="p-1.5 sm:p-2 rounded-lg bg-gray-800 hover:bg-red-950 text-gray-400 hover:text-red-400 border border-gray-700 hover:border-red-800 transition-colors cursor-pointer"
